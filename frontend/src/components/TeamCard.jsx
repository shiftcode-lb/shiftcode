  ...
  return (
    <div className="items-center rounded-lg shadow sm:flex bg-gray-800 border-gray-700">
              <div className='w-full sm:w-auto'>
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/jese-leos.png" alt="Member picture" />
              </div>
              <div className="p-5">
                  <h3 classNameName="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      Jese Leos
                  </h3>
