...
const Footer = () => {
    return (
        ...
        <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-[#587d8f] to-[#2f4157] text-white/70">
            
            <img src={assets.logo} alt="" className="w-[200px] h-[40px]"/>
