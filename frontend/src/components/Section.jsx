...
const Section = ({Title, image, text, text2, flex}) => {
  ...
  return (
    ...
    justify-between items-center w-full mx-auto px-3 sm:px-4 md:px-11 lg:px-13 xl:px-12 2xl:px-16 max-w-screen-xl `}>
      {/** Left banner  */}
      <div className='flex flex-col gap-3 md:w-1/2 w-full' data-aos="fade-up" data-aos-delay="300">
      ...
      {/** Right banner */}
      <div className='md:w-1/2 w-full rounded-2xl' data-aos="fade-up" data-aos-delay="300">
