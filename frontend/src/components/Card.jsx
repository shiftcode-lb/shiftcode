...
const Card = ({cardTitle, cardText, cardImage}) => {
  ...
  className="group bg-coprimary rounded-[5px] px-10 py-5 border-2 border-coprimary
    ...
    lg:w-[290px] xl:w-[350px] lg:h-[346px] md:w-[240px] md:h-[365px] w-full
...
>
  <div className="flex flex-col h-full justify-between">
    {/* Icon Container */}
    <div className="p-3 rounded-md mb-6 group-hover:bg-primary transition-colors duration-300 bg-background w-max mx-auto md:mx-0 md:self-start">
